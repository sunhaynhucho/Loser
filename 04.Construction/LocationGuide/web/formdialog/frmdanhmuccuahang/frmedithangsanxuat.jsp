...
<%
    ...
    List lKhoHang = DanhMucCuaHangDataLogic.getListHangSanXuatTheoMa(maHangSX);
...
<div style="padding:10px 0 10px 60px">  
    <input type="hidden" id="frmEditMaHangSX" value="<%=maHangSX%>" />
    <table>  
        <tr>  
            <td>Tên hãng sản xuất:</td>  
            <td><input class="easyui-validatebox" type="text" id="frmEditTenHangSanXuat" maxlength="99" data-options="required:true" value="<%=tenKho%>"></input></td>  
        </tr>  
        <tr>  
            <td>Điện thoại:</td>  
