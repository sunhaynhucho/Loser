...
<%
    ...
    List lKhoHang = DanhMucCuaHangDataLogic.getListKhoHangTheoMaKho(maKho);
...
<div style="padding:10px 0 10px 60px">  
    <input type="hidden" id="frmEditMaKho" value="<%=maKho%>" />
    <table>  
        <tr>  
            <td>Tên kho hàng:</td>  
            <td><input class="easyui-validatebox" type="text" id="frmEditTenKho" maxlength="99" data-options="required:true" value="<%=tenKho%>"></input></td>  
        </tr>  
        <tr>  
            <td>Điện thoại:</td>  
...
<div style="text-align:center;padding:5px">  
    <a href="javascript:void(0)" class="easyui-linkbutton" onclick="submitFormEditUser()">Đồng ý</a>  
</div>  
