   ...
   var render = function (responseXML, doc) {
      ...
      if (!responseXML) {
         ...
         for (i = 0; i < placemarkNodes.length; i++) {
            ...
            desc = desc + "</font>";
            desc = desc.replace("src=\"","src=\"kmz/"+datetime+"\/");
            placemark = {
         ...
         for (i = 0; i < groundNodes.length; i++) {
            ...
            groundOverlay = {
               ...
               //Hard coding a "kmz" directory for kmz external references
               icon: {href: 'kmz/'+datetime+'/'+geoXML3.nodeValue(node.getElementsByTagName('href')[0])},
               latLonBox: {
